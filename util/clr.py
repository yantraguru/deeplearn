...
class OneCycleLR(Callback):
    ...
    def compute_lr(self):
        ...
        """
        #print('self.initial_lr : %f' % self.initial_lr)
        #print('self.end_percentage : %f' % self.end_percentage)
        if self.clr_iterations > 2 * self.mid_cycle_id:
            target_lr = (self.initial_lr*self.end_percentage)/10.0
            current_period = int(self.num_iterations - self.clr_iterations)
            full_period = int(self.num_iterations - 2 * self.mid_cycle_id)
            #percentage_down = ((1/100.0)**(1/full_period)) - 1
            lr_decay = ((self.initial_lr*self.end_percentage) - target_lr)/full_period
            
            if current_period <= 1 :
                new_lr = target_lr
            else :
                #new_lr = (self.initial_lr*self.end_percentage)*((1+percentage_down)**(full_period - current_period))
                new_lr = (self.initial_lr*self.end_percentage) - (lr_decay * (full_period - current_period))
                #print('self.end_lr : %f' % (self.initial_lr*self.end_percentage))
                #print('current_period : %f' % current_period)
                #print('full_period : %f' % full_period)
                #print('percentage_down : %f' % lr_decay)
                #print('new_lr : %f' % new_lr)
    ...
    def on_train_begin(self, logs={}):
        ...
        print('num of steps : %d' %self.steps)
        print('num of epochs : %d' %self.epochs)
        ...
        print('num of iterations : %d' %self.num_iterations)
        self.mid_cycle_id = int(self.num_iterations * ((1. - self.end_percentage)) / float(2))
        print('mid cycle id : %d ' %self.mid_cycle_id)
